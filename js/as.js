const as = {}
 as.container = function(){
  ...
  cnt.setAttribute("style", "display: none;position: fixed;bottom: 0;left: 0;width: 100%;height: 40vh;background-color: #fff;z-index: 99999999999999999999999999999999;transition: display 1s;");
