var as = {}
 as.container = function(){
  ...
  var astools = [
      "<style>.as-tool{height: 100%;width: 100%;margin-top: 5px;word-wrap: break-word;overflow-y: scroll;}.as-run-code-buttons{height: 34px;width: 33%;}#as-resources .as-resources{border: 1px solid #000;background-color: #fff;margin: 10px;}#as-resources .as-resources-head{display: block;color: #f00;padding: 10px;width: 100%;background-color: #eee;font-family: cursive;}</style>",
 ...
 as.set = function(n){
   ...
   document.getElementById(id+"-btn").style.backgroundColor = "#f00";
   if(n == "resources"){
     as.getAllResources();
   }
 ...
 as.button = function(){
  ...
  btn.setAttribute("style", "border: none;position: fixed;bottom: 15px;right: 15px;height: 49px;width: 50px;background-color: #2196F3;color: #fff;border-radius: 10px;text-align: center;z-index: 9999999999999999999999999999999999;");
 ...
 as.init = function(){
  as.container();
  as.button();
  var style = "<style>#asbtn.is-pointer-down{background-color: #29a !important;}</style>";
